  ...
  <el-row class="tac">
    <el-col>
      <div class="el-menu-box">
        <el-menu unique-opened router :default-active=" `/${item.path}/${item1.path}`" class="el-menu-vertical-demo">
          <template v-for="(item,index) in menus">
            ...
            <el-submenu :index="`/${item.path}`" :key="item.path" v-else>
              ...
              <el-menu-item-group>
                <el-menu-item  :index="`/${item1.path}`" v-for="(item1) in item.children" :key="item1.path">
