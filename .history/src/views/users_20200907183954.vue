  ...
  <div>
    <el-card class="box-card">
      ...
      <div class="table-box">
        ...
        <cwTable :IndexFlag="IndexFlag" cell-click="clickCell" :tableData="tableData" @handleCurrentChange="handleCurrentChange" @handleSizeChange="handleSizeChange" :total="total" :columns="columns" :showPageNation="showPageNation">
...
export default {
  ...
  mounted() {
    ...
    this.tableData = this.userDataList
