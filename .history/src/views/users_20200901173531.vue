        ...
        <el-table ref="singleTable" :data="userDataList" border highlight-current-row @current-change="handleCurrentChange" style="width: 100%">
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              ...
              <el-dialog title="收货地址" align="left" :visible.sync="dialogFormVisibleEdit">
               ...
               <el-dialog title="收货地址" align="left" :visible.sync="dialogFormVisibleDelet">
                ...
                <div slot="footer" class="dialog-footer">
                  <el-button @click="dialogFormVisibleDelet = false">取 消</el-button>
                  <el-button type="primary" @click="dialogFormVisibleDelet = false">确 定</el-button>
                </div>

              </el-dialog>
               <el-dialog title="收货地址" align="left" :visible.sync="dialogFormVisibleSet">
